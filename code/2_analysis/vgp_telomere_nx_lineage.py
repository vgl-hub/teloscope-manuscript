#!/usr/bin/env python3
"""
Telomere Nx plots for VGP assemblies – per-run workflow (v10).
...
run_label = "v10"  # Label for output filenames

vgp_metadata_file = os.path.join(data_dir, "25.09.25_metadata_telomere_assembly_simplified.csv")
vgp_terminal_telomeres = os.path.join(data_dir, "25.12.05_compiled_TTAGGG_terminal_telomeres_longest_pq.bed")
